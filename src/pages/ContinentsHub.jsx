...
export default function ContinentsHub({ onNavigate }) {
  const categories = [
    { path: '/continents', icon: Mountain, title: 'Continents', description: 'Masses continentales de vos mondes' },
    { path: '/countries-hub', icon: Flag, title: 'Pays', description: 'Nations et leurs territoires' }
  ];

  return (
    <div className="flex items-center justify-center min-h-screen p-8 bg-transparent">
      <div className="text-center max-w-7xl">
        <h1 className="text-5xl font-black text-[#2DD4BF] mb-4 drop-shadow-lg uppercase tracking-tighter">Continents & Territoires</h1>
        <p className="text-xl text-soft-white/80 mb-12 font-medium">Gérez la géographie et les divisions territoriales</p>

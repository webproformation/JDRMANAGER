...
import { Shield, Sword, Award, Check } from 'lucide-react';
...
// --- L'ÉDITEUR SUR-MESURE (Stats + Santé & Combativité avec Modificateurs dynamiques) ---
const ConnectedStatsEditor = ({ value, onChange, formData }) => {
  ...
  // Calcul des valeurs affichées incluant les "overrides" manuels de l'utilisateur
  ...
  // Composant local pour les widgets avec boutons +/-
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Santé & Combativité (Modifiables via Overrides intelligents) */}
      <div className="grid grid-cols-3 md:grid-cols-6 gap-3 mt-6">
        ...
        {/* Les deltas sont sauvegardés comme modificateurs pour ne pas écraser les formules du rulesEngine */}
  ...
  fields: [
      ...
      render: (val, item) => {
        ...
        return (
          <div className="space-y-8">
            {/* 6 Caractéristiques de base en Consultation */}
            ...
            {/* Santé & Combativité en Consultation */}
            <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
               {/* PV */}
    ...
    { 
      ...
      component: ({ formData, onFullChange }) => {
        ...
        // Prise en compte du bonus de Maîtrise s'il a été manuellement altéré par l'utilisateur
           ...
           <div className="bg-[#151725] p-5 rounded-2xl border border-white/5 mt-4 shadow-inner">
              ...
              <div className="grid gap-4 grid-cols-2 md:grid-cols-3">
                {DND_SKILLS.map(sk => {
                   ...
                   // Calcul du vrai bonus total aligné avec le potentiel override de maîtrise

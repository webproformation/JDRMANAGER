      ...
      {activeTab === 'economy_tab' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className={boxStyle + " min-h-[150px] items-start py-4 text-amber-200/80 bg-amber-500/5 border-amber-500/10"}>
              {renderFieldValue(getField('treasures'))}
            </div>
          </div>
        </div>
      )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {['gm_secrets_village', 'dangers'].map(name => (
              <div key={name}>
                ...
                <div className={boxStyle + " min-h-[150px] items-start py-3 bg-red-500/5 border-red-500/10 text-red-100/70"}>
                  {renderFieldValue(getField(name))}
                </div>
              </div>
            ))}

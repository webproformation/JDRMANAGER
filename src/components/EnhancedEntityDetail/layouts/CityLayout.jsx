...
import { Shield, History, CalendarDays, Map, Building2, Users, DollarSign, Info, X, ChevronLeft, ChevronRight } from 'lucide-react';

// Import du moteur autonome V4.2
...
/**
 * CityLayout - Version Prestige 4.5.9 (ÉPURE TOTALE)
 */
export default function CityLayout({ item, config, activeTab, renderFieldValue }) {
  ...
  // STYLES PURS PRESTIGE (Typo blanche, sans blocs)
  ...
  const smartRender = (field) => {
    ...
    const isGraphic = field.type === 'images' || field.name === 'city_images' || field.type === 'world_history_editor';
    ...
    // Fallback pour les tableaux simples
  ...
  return (
    <div className="animate-in fade-in duration-500 pb-20">
            ...
            <div className="md:col-span-8 flex flex-col gap-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-12 h-full content-start">
                ...
                <div className="sm:col-span-2">
                  <label className={labelStyle}>État / Pays</label>
      ...
      {/* ==================================================================
          3. QUARTIERS ET LIEUX : 3, 2, 2 ÉPURÉ
          ================================================================== */}
      {activeTab === 'districts' && (
        <div className="space-y-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
      ...
      {activeTab === 'economy' && (
        <div className="w-full">
          <label className={labelStyle}>Économie Urbaine</label>
          <div className={descriptionStyle}>{smartRender(getField('economy'))}</div>
        </div>
      )}

      {/* ==================================================================
          6. HISTOIRE (MOTEUR V4.2)
          ================================================================== */}
      {activeTab === 'history' && (
        <div className="space-y-12">
          <div className="w-full">
      ...
      {/* ==================================================================
          ...
          ================================================================== */}
      {activeTab === 'gallery' && (
        <div className="py-4">{smartRender(getField('city_images'))}</div>
      )}

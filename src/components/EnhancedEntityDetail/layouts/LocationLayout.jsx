...
import { Shield, ShoppingBag, Skull, History, CalendarDays, Info, X, ChevronLeft, ChevronRight } from 'lucide-react';
...
/**
 * LocationLayout - Version Prestige 4.5.9 (ÉPURE TOTALE)
 */
export default function LocationLayout({ item, config, activeTab, renderFieldValue }) {
  ...
  const smartRender = (field) => {
    ...
    const isGraphic = field.type === 'images' || field.name === 'location_images' || field.type === 'world_history_editor';
    ...
    if (field.name === 'country_id' && rawValue && rawValue !== '—') return <RelationDisplay tableName="countries" id={rawValue} />;
  ...
  return (
    <div className="animate-in fade-in duration-500 pb-20">
      ...
      {/* ==================================================================
          2. EXPLORATION : Grille 3 + 2 (ÉPURE)
          ================================================================== */}
      ...
      {/* ==================================================================
          3. HISTOIRE (MOTEUR V4.3)
          ================================================================== */}
      {activeTab === 'history_tab' && (
        <div className="space-y-12">
          <div className="w-full">
            <label className={labelStyle}>Mémoire des Pierres & Chroniques du Monde</label>
            <div className="rounded-[3.5rem] overflow-hidden border border-amber-500/10 bg-black/20 p-1 shadow-2xl">
              <div className="bg-amber-500/5 p-12 relative overflow-hidden">
                <div className="absolute top-0 right-0 p-10 opacity-5 pointer-events-none">
                  <CalendarDays size={140} className="text-amber-400" />
                </div>
      ...
      {/* ==================================================================
          4. SERVICES & COMMERCES (ÉPURE)
          ================================================================== */}
      {activeTab === 'services' && (
        <div className="space-y-12">
          <div className="flex items-center gap-3 text-amber-500/80 mb-4 px-1">
            <ShoppingBag size={18} />
            <h4 className="text-[11px] font-black uppercase tracking-[0.3em]">Services Disponibles</h4>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
      ...
      {/* ==================================================================
          5. DANGERS & TRÉSORS (ÉPURE)
          ================================================================== */}
      {activeTab === 'dangers' && (
        <div className="space-y-12">
          <div className="flex items-center gap-3 text-red-500/80 mb-4 px-1">
            <Skull size={18} />
            <h4 className="text-[11px] font-black uppercase tracking-[0.3em]">Menaces & Récompenses</h4>
          </div>
          <div className="w-full">
            <label className={labelStyle}>Niveau de danger</label>
            <div className="text-red-500 font-black text-2xl uppercase tracking-[0.2em] px-1 drop-shadow-[0_0_10px_rgba(239,68,68,0.3)]">
              {smartRender(getField('danger_level'))}
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-white/5 pt-12">
      ...
      {/* ==================================================================
          ...
          ================================================================== */}
      {activeTab === 'gallery' && (
        <div className="py-4">{smartRender(getField('location_images'))}</div>
      )}

      {/* ==================================================================
          7. MJ : ARCHIVES SECRÈTES (ÉPURE ROUGE)
          ================================================================== */}
      {activeTab === 'gm' && (
        <div className="space-y-12">
          <div className="flex items-center gap-3 text-red-500/80 mb-4 px-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className={descriptionStyle + " text-red-200/80 italic"}>
                {smartRender(getField('gm_secrets_location'))}
              </div>
            </div>
            <div>

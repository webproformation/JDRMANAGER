...
export default function EnhancedEntityForm({
  ...
  // ZÉRO ASCENSEUR : Injection de style global
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      <div className="relative w-full max-w-7xl h-[95vh] bg-[#0f111a] rounded-[2.5rem] flex flex-col overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)] border border-white/10 animate-in zoom-in-95 duration-300 pointer-events-auto">
        ...
        <div className="flex-1 flex overflow-hidden relative">
          ...
          {/* lg:pr-24 EMPÊCHE LE TEXTE DE PASSER SOUS LES FLÈCHES */}
          <div ref={contentRef} className="flex-1 overflow-y-auto p-10 lg:pl-16 lg:pr-24 pb-40 no-scrollbar scroll-smooth">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-[#0f111a] via-[#0f111a] to-transparent pointer-events-none flex justify-end z-20">
             <div className="pointer-events-auto flex gap-6 items-center">
               ...
               <button type="submit" form="entity-form" disabled={loading} className="flex items-center gap-3 px-10 py-4 rounded-2xl font-black uppercase text-[10px] shadow-2xl transition-all bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-500 hover:to-cyan-500 text-white hover:scale-105 active:scale-95">
